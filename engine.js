(function () {
  ...
  const CLEAR_DIVINE_FATHER_CONTEXT =
    /\b(GOD|CHRIST|MESSIAH|ANOINTED ONE|JESUS|HOLY SPIRIT|SPIRIT OF GOD|THE LORD|LORD GOD|SON OF GOD|MY BELOVED SON|VOICE FROM HEAVEN|HEAVENLY)\b/i;
  const RELIGIOUS_FATHER_CONTEXT =
    /\b(GOD|CHRIST|MESSIAH|ANOINTED ONE|JESUS|HOLY SPIRIT|SPIRIT OF GOD|THE LORD|LORD GOD|SON OF GOD|MY BELOVED SON|VOICE FROM HEAVEN|HEAVENLY|PROPHET|SCRIPTURE|BAPTIZ|KINGDOM|RIGHTEOUSNESS|SALVATION|WORSHIP)\b/i;
